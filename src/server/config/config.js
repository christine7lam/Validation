...
function init(options) {
    ...
    var config = convict({
        endpoints: {
            auth: {
                host: {
                    doc: 'User Auth host name',
                    format: String,
                    default: null,
                    env: 'ENDPOINTS_AUTH_HOST'
                },
                path: {
                    doc: 'User Auth path',
                    format: String,
                    default: '/api/v1',
                    env: 'ENDPOINTS_AUTH_PATH'
                },
                port: {
                    doc: 'User Auth port',
                    format: 'port',
                    default: 80,
                    env: 'ENDPOINTS_AUTH_PORT'
                },
                protocol: {
                    doc: 'User Auth protocol',
                    format: String,
                    default: 'http',
                    env: 'ENDPOINTS_AUTH_PROTOCOL'
                }
            },
            data: {
                host: {
                    doc: 'Device data host name',
                    format: String,
                    default: null,
                    env: 'ENDPOINTS_DATA_HOST'
                },
                path: {
                    doc: 'Device data path',
                    format: String,
                    default: '/api/v1/device-data',
                    env: 'ENDPOINTS_DATA_PATH'
                },
                port: {
                    doc: 'Device data port',
                    format: 'port',
                    default: 80,
                    env: 'ENDPOINTS_DATA_PORT'
                },
                protocol: {
                    doc: 'Device data protocol',
                    format: String,
                    default: 'http',
                    env: 'ENDPOINTS_DATA_PROTOCOL'
                }
            },
            health: {
                host: {
                    doc: 'Device health host name',
                    format: String,
                    default: null,
                    env: 'ENDPOINTS_HEALTH_HOST'
                },
                path: {
                    doc: 'Device health path',
                    format: String,
                    default: '/api/v1',
                    env: 'ENDPOINTS_HEALTH_PATH'
                },
                port: {
                    doc: 'Device health port',
                    format: 'port',
                    default: 80,
                    env: 'ENDPOINTS_HEALTH_PORT'
                },
                protocol: {
                    doc: 'Device health protocol',
                    format: String,
                    default: 'http',
                    env: 'ENDPOINTS_HEALTH_PROTOCOL'
                }
            },
            directory: {
                host: {
                    doc: 'Device directory host name',
                    format: String,
                    default: null,
                    env: 'ENDPOINTS_DIRECTORY_HOST'
                },
                path: {
                    doc: 'Device directory path',
                    format: String,
                    default: '/api/v1',
                    env: 'ENDPOINTS_DIRECTORY_PATH'
                },
                port: {
                    doc: 'Device directory port',
                    format: 'port',
                    default: 80,
                    env: 'ENDPOINTS_DIRECTORY_PORT'
                },
                protocol: {
                    doc: 'Device directory protocol',
                    format: String,
                    default: 'http',
                    env: 'ENDPOINTS_DIRECTORY_PROTOCOL'
                }
            },
            datamodel: {
                host: {
